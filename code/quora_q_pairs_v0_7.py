...
num_lstm = 255#np.random.randint(175, 275)#255#
...
# bi_lstm_layer_last = Bidirectional(GRU(num_lstm, dropout=rate_drop_lstm, recurrent_dropout=rate_drop_lstm, return_sequences=False))
bi_lstm_layer1 = Bidirectional(GRU(num_lstm, dropout=rate_drop_lstm, recurrent_dropout=rate_drop_lstm, return_sequences=True))
# class AttLayer(Layer):
#     def __init__(self, **kwargs):
#         self.init = keras.initializers.RandomNormal()
...
# atten_layer = AttLayer()
# time_dis = TimeDistributed(Dense(num_dense))

# def add_attetion_layer(activations, units):
#     print('#################')
...
#     print(attention)
#     print(activations)
#     activations2 = TimeDistributed(Dense(units))(activations)
#     print(activations2)
#     sent_representation = multiply([activations2, attention])#merge([activations, attention], mode='mul')
...
# x1 = add_attetion_layer(x1, num_lstm)
...
# y1 = add_attetion_layer(y1, num_lstm)
...
# preds = Dense(1, activation='sigmoid')(concatenate([preds1, preds2])))
...
hist = model.fit([data_1_train, data_2_train], labels_train, \
        ...
        epochs=200, batch_size=1500, shuffle=True, \
...
preds = model.predict([test_data_1, test_data_2], batch_size=3000, verbose=1)
preds += model.predict([test_data_2, test_data_1], batch_size=3000, verbose=1)
preds /= 2
