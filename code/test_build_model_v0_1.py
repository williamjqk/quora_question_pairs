...
# lstm_layer = LSTM(num_lstm, dropout=rate_drop_lstm, recurrent_dropout=rate_drop_lstm, name='lstm1')
# with tf.name_scope('name_input_layer'):
...
# with tf.name_scope('name_embedding_layer'):
#     embedded_sequences_1 = embedding_layer(sequence_1_input)
#     embedded_sequences_2 = embedding_layer(sequence_2_input)
# with tf.name_scope('name_rnn_layer'):
...
bi_lstm_layer1 = Bidirectional(LSTM(num_lstm, return_sequences=True, 'lstm1'), name='biRNN1')
bi_lstm_layer2 = Bidirectional(LSTM(num_lstm, return_sequences=True, 'lstm2'), name='biRNN2')
bi_lstm_layer3 = Bidirectional(LSTM(num_lstm, return_sequences=False, 'lstm3'), name='biRNN3')
with tf.name_scope('name_input_layer'):
    sequence_1_input = Input(shape=(MAX_SEQUENCE_LENGTH,), dtype='int32', name='input1')
    sequence_2_input = Input(shape=(MAX_SEQUENCE_LENGTH,), dtype='int32', name='input2')
with tf.name_scope('name_embedding_layer'):
...
#         input_length=MAX_SEQUENCE_LENGTH)
# lstm_layer1 = LSTM(num_lstm, dropout=rate_drop_lstm, recurrent_dropout=rate_drop_lstm, return_sequences=True)
# lstm_layer2 = LSTM(num_lstm, dropout=rate_drop_lstm, recurrent_dropout=rate_drop_lstm, return_sequences=True)
# lstm_layer3 = LSTM(num_lstm, dropout=rate_drop_lstm, recurrent_dropout=rate_drop_lstm, return_sequences=True)
# lstm_layer_last = LSTM(num_lstm)
# sequence_1_input = Input(shape=(MAX_SEQUENCE_LENGTH,), dtype='int32')
# embedded_sequences_1 = embedding_layer(sequence_1_input)
# x1 = Bidirectional(lstm_layer1)(embedded_sequences_1)
# x1 = Bidirectional(lstm_layer2)(x1)
# x1 = Bidirectional(lstm_layer3)(x1)
# x1 = Bidirectional(lstm_layer_last)(x1)
# sequence_2_input = Input(shape=(MAX_SEQUENCE_LENGTH,), dtype='int32')
# embedded_sequences_2 = embedding_layer(sequence_2_input)
# y1 = Bidirectional(lstm_layer1)(embedded_sequences_2)
# y1 = Bidirectional(lstm_layer2)(y1)
# y1 = Bidirectional(lstm_layer3)(y1)
# y1 = Bidirectional(lstm_layer_last)(y1)
# # v_similarity = dot([x1, y1], axes = 1, normalize = True)
# # preds = Dense(1, activation='sigmoid')(v_similarity)
# merged = concatenate([x1, y1], axis=-1)
# merged = Dropout(rate_drop_dense)(merged)
# merged = BatchNormalization()(merged)
# merged = Dense(num_dense, activation=act)(merged)
# merged = Dropout(rate_drop_dense)(merged)
